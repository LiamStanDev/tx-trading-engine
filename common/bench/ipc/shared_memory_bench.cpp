...
BENCHMARK(BM_Create_Huge)->Name("SHM/Open/HugePage")->UseRealTime();
...
BENCHMARK(BM_Open_Regular)->Name("SHM/Open/RegularPage")->UseRealTime();
...
BENCHMARK(BM_Open_And_FirstAccess_Regular)->Name("SHM/OpenAndFirstAccess/Regular")->UseRealTime();
...
BENCHMARK(BM_Open_Huge)->Name("SHM/Open/Huge")->UseRealTime();
