#ifndef ONYX_IO_SOCKET_ADDRESS_HPP
#define ONYX_IO_SOCKET_ADDRESS_HPP
...
class SocketAddress {
 ...
 public:
  ...
  /// @param port 埠號 (主機位元序)
  ///
  static Result<SocketAddress> from(std::string_view ip, uint16_t port) noexcept;
  ...
  /// @return in_addr 指標
  ///
  [[nodiscard]] const struct in_addr* addr_ptr() const noexcept { return &addr4_.sin_addr; }
